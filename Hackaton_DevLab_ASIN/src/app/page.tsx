      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div>
              <span className="font-bold text-xl text-gray-900 tracking-tight block leading-tight uppercase">Gbé<span className="text-emerald-600 uppercase">dagbé</span></span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                ...
                {/* <span className="text-xl font-bold">GBEDAGBE</span> */}
              </div>
            ...
            <div>
              ...
              <ul className="space-y-4 text-gray-400">
                ...
                <li className="flex items-center gap-3"><Mail size={18} className="text-emerald-500" /><span>contact@Gbèdagbé.bj</span></li>
